# codegraph-cli-workflow Specification

## Purpose

Defines the CLI-first CodeGraph workflow for Pi, including global CLI availability, automatic repository initialization, semantic exploration preferences, synchronization policy, optional repository-local Git hooks, and generated index handling.
