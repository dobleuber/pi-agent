...
- [x] 3.3 Implement `/router local off` to persist remote mode, switch the active router model to GPT-5.4 Mini, and stop the local llama.cpp server.
...
- [x] 4.5 Add tests for OpenAI Codex subscription routing and unavailable-model passthrough behavior.
