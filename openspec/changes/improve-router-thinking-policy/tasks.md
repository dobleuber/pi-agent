...
- [x] 3.1 Add failing integration tests proving model routing activates only for the OpenAI Codex GPT-5.6 Luna/Terra/Sol family and preserves ZAI, Anthropic, and other external models.
