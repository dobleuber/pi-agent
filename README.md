...
- The tracked extension collection includes answer/context tools, review workflows, loop and todo controls, clipboard/file helpers, network retry, notifications, session breakdowns, and the remote GPT-mini Pi router.
